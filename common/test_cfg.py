# -*- coding: utf-8 -*-
"""
Created on Mon Oct 20 16:44:49 2014
...
corporaRead.init('../corpora/Our_corpora/wardrobe_corpus/wardrobe.cfg');
cfg = corporaRead.build_cfg();

superNovaGrammar = cfg;
...
sents = corporaRead.get_corpus_sents();
